...
bool VulkanRenderer::createInstance() {
    ...
    appInfo.applicationVersion = VK_MAKE_API_VERSION(0, RF_VERSION_MAJOR, RF_VERSION_MINOR, RF_VERSION_PATCH);
    appInfo.pEngineName = "RuneForge Native";
    appInfo.engineVersion = VK_MAKE_API_VERSION(0, RF_VERSION_MAJOR, RF_VERSION_MINOR, RF_VERSION_PATCH);
